...
public class FullSudoku
{
	...
	OneStepAttempt[] allStepAttempts = {
		...
		new OneStepAttempt(){public StepInfo callMethod(FullSudoku mySudoku){return FishTwoThreeFour.X_Wing(mySudoku);} },
		new OneStepAttempt(){public StepInfo callMethod(FullSudoku mySudoku){return FishTwoThreeFour.Swordfish(mySudoku);} },
		new OneStepAttempt(){public StepInfo callMethod(FullSudoku mySudoku){return FishTwoThreeFour.Jellyfish(mySudoku);} }
	};
